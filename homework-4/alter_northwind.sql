...
-- Create a table that contains all products
SELECT * INTO all_products FROM products;
INSERT INTO all_products SELECT * FROM new_products;
-- Set constraint for new table
ALTER TABLE all_products ADD PRIMARY KEY (product_id);
-- Restore constraint for "order_details" table
